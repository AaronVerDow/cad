...
module front() {
    difference() {
        cylinder(d1=mbs_front_d1,d2=mbs_front_d2,h=mbs_front_h);
        cylinder(d1=mbs_front_d2-mbs_front_h*2,d2=mbs_front_d2,h=mbs_front_h+pad);
...
module mbs_back() {
    cylinder(d1=mbs_back_d1, d2=mbs_back_d2, h=mbs_h);   
}
